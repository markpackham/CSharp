...
namespace Serialization
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            using (TextWriter tw = new StreamWriter(@"E:\xampp\htdocs\CSharp\Serialization\SerializationExamples\bowser.xml"))
            {
            ...
            TextReader reader = new StreamReader(@"E:\xampp\htdocs\CSharp\Serialization\SerializationExamples\bowser.xml");
            ...
            using (Stream fs = new FileStream(@"E:\xampp\htdocs\CSharp\Serialization\SerializationExamples\animals.xml",
            ...
            using (FileStream fs2 = File.OpenRead(@"E:\xampp\htdocs\CSharp\Serialization\SerializationExamples\animals.xml"))
            {
            ...
            {
                //Remember ToString was overriden in the Animal class so output is 
