...
namespace GenericsDelegates
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            // and provide performance benefits compared to just using objects
            // Or writing the same fuction over and over again to handle different parameters
            ...
            // previously, the letter T is just a naming convention there is nothing special about it
