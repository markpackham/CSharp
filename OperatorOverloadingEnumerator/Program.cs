...
namespace OperatorOverloadingEnumerator
{
    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            // ToString
            Console.WriteLine($"(operator +) Box 3 : {box3}");

            Console.WriteLine($"explicit operator int(Box b) Box Int : {(int)box3}");

            // Convert an int into a Box
            Box box4 = (Box)4;

            Console.WriteLine($"implicit operator Box(int i) Box 4 : {(Box)4}");
