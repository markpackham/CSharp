...
namespace LINQ_Queries
{
    ...
    class Program
    {
        ...
        static int[] QueryIntArray()
        {
            ...
            // The type is an enumerable, enumerable means able to be counted by one-to-one correspondence with the set of all positive integers
        ...
        static void QueryAnimalData()
        {
            ...
            Console.WriteLine();
            Console.WriteLine("Inner Join where AnimalID = OwnerID");
            ...
            //we have a foreach in a foreach so we first see the owners and then all the animals that belong to them
