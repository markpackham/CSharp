...
namespace LINQListManipulation
{
    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            foreach (var m in sNameList)
                Console.WriteLine("StartsWith('S') " + m);
            ...
            foreach (var n in sumList)
                Console.WriteLine("listOne & listTwo Zipped " + n);
            ...
            Console.WriteLine("AGGREGATE Sum : {0}",
            ...
            Console.WriteLine("AsQueryable().Average() : {0}",
            ...
            Console.WriteLine("(Remaining numbers that don't show up in numList7) Except : {0}",
            ...
            Console.WriteLine("(Both lists have these) Intersect : {0}",
